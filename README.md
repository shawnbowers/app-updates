...
lookit/
  ...
  download/Lookit.dmg  # what the site links to
kaboodle/
  appcast.xml
  Kaboodle-<version>.zip
  download/Kaboodle.dmg
```
...
| Kaboodle | https://shawnbowers.github.io/app-updates/kaboodle/appcast.xml |
